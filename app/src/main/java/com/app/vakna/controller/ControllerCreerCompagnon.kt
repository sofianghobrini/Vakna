...
class ControllerCreerCompagnon(private val binding: ActivityCreerCompagnonBinding) {
    ...
    init {
        ...
        val jouet1  = Objet(0, "Jouet 1" , 15, 5 , TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet2  = Objet(1, "Jouet 2" , 20, 6 , TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet3  = Objet(2, "Jouet 3" , 25, 7 , TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet4  = Objet(3, "Jouet 4" , 30, 8 , TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet5  = Objet(4, "Jouet 5" , 35, 9 , TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet6  = Objet(5, "Jouet 6" , 40, 10, TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet7  = Objet(6, "Jouet 7" , 45, 11, TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet8  = Objet(7, "Jouet 8" , 50, 12, TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet9  = Objet(8, "Jouet 9" , 55, 13, TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")
        val jouet10 = Objet(9, "Jouet 10", 60, 14, TypeObjet.JOUET, "jouet", "file:///android_asset/jouets/")

        val jouetsItems = listOf(jouet1, jouet2, jouet3, jouet4, jouet5, jouet6, jouet7, jouet8, jouet9, jouet10)

        val kebab    = Objet(10, "Kebab"   , 8 , 10, TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_kebab.png")
        val pizza    = Objet(11, "Pizza"   , 12, 15, TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_pizza.png")
        val burger   = Objet(12, "Burger"  , 10, 8 , TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_burger.png")
        val sandwich = Objet(13, "Sandwich", 7 , 5 , TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_sandwich.png")
        val salade   = Objet(14, "Salade"  , 6 , 4 , TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_salade.png")
        val pasta    = Objet(15, "Pasta"   , 11, 9 , TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_pasta.png")
        val sushi    = Objet(16, "Sushi"   , 14, 13, TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_sushi.png")
        val steak    = Objet(17, "Steak"   , 20, 18, TypeObjet.NOURRITURE, "nourriture", "file:///android_asset/nourriture/nourriture_steak.png")
